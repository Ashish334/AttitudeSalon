...
const MAPS_EMBED = 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.0!2d77.2!3d28.6!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjjCsDM2JzAwLjAiTiA3N8KwMTInMDAuMCJF!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin';
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              >
                <div className="w-12 h-12 bg-gold-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-gold-600 transition-colors">
                  <Phone size={20} className="text-gold-600 group-hover:text-white transition-colors" />
                </div>
                <div>
                  <div className="font-semibold text-salon-dark">Phone</div>
                  <div className="text-gray-500 text-sm">+91 99999 99999</div>
                  <div className="text-gold-600 text-xs font-medium mt-0.5">Click to call</div>
                </div>
              </a>
              ...
              >
                <div className="w-12 h-12 bg-green-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-green-500 transition-colors">
                  <svg viewBox="0 0 24 24" className="w-5 h-5 text-green-500 group-hover:text-white fill-current transition-colors">
                ...
                <div>
                  ...
                  <div className="text-gray-500 text-sm">+91 99999 99999</div>
                  <div className="text-green-600 text-xs font-medium mt-0.5">Chat with us</div>
                </div>
              </a>

              <a
                href="mailto:hello@attitudesalon.com"
                className="flex items-start gap-4 p-4 rounded-2xl hover:bg-salon-cream transition-colors group"
              >
                <div className="w-12 h-12 bg-gold-50 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:bg-gold-600 transition-colors">
                  <Mail size={20} className="text-gold-600 group-hover:text-white transition-colors" />
                </div>
                <div>
                  <div className="font-semibold text-salon-dark">Email</div>
                  <div className="text-gray-500 text-sm">hello@attitudesalon.com</div>
                </div>
              </a>
            ...
            <div className="bg-salon-cream rounded-2xl p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="font-heading font-semibold text-salon-dark">Business Hours</h3>
              </div>
              <div className="space-y-2">
                {hours.map((h) => (
                  <div key={h.day} className="flex justify-between text-sm">
                    <span className="text-gray-600">{h.day}</span>
                    <span className="text-salon-dark font-medium">{h.time}</span>
                  </div>
                ))}
              </div>
            </div>
