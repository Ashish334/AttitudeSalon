...
export default function Booking() {
  ...
  return (
    <section id="booking" className="py-24 bg-salon-dark relative overflow-hidden">
      {/* Decorative elements */}
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <p className="text-gold-400 text-sm font-semibold uppercase tracking-widest mb-2">Make a Reservation</p>
          <h2 className="font-heading text-3xl md:text-4xl font-bold text-white mb-3">
            Book Your <span className="text-gold-400 italic">Appointment</span>
          </h2>
          <p className="text-gray-400 max-w-lg mx-auto">
            Fill in the form below and we'll confirm your booking via WhatsApp. It only takes a minute!
          </p>
        </div>
        ...
        <div className="bg-white/5 backdrop-blur border border-white/10 rounded-3xl p-8 md:p-12">
          {submitted ? (
            <div className="text-center py-8 animate-fade-in">
              ...
              <h3 className="font-heading text-2xl text-white mb-2">Booking Request Sent!</h3>
              <p className="text-gray-400">
                Your WhatsApp message has been prepared. We'll confirm your appointment shortly.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="grid md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                >
                  <option value="" className="bg-salon-dark">Select a service</option>
                  {services.map((s) => (
                    <option key={s} value={s} className="bg-salon-dark">{s}</option>
                  ))}
                </select>
              </div>
              ...
              {/* Date */}
              <div>
                <label className="block text-gray-300 text-sm font-medium mb-2">Preferred Date *</label>
              ...
              {/* Submit */}
              <div className="md:col-span-2">
                <button type="submit" className="w-full btn-gold py-4 text-base flex items-center justify-center gap-2">
